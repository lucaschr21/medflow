...
@Table(name = "agenda_medica", indexes = {
...
}, uniqueConstraints = @UniqueConstraint(name = "uk_agenda_medica_alocacao_dia_horas", columnNames = {
        "alocacao_medico_id", "dia_semana", "hora_inicio",
        "hora_fim" }), check = @CheckConstraint(name = "ck_agenda_medica_intervalo", constraint = "hora_fim > hora_inicio"))
@NoArgsConstructor
