...
/**
 * Representa o registro clinico produzido durante o atendimento de uma
 * consulta.
 */
@Getter
@Setter
@Entity
@Audited
@Table(name = "registro_atendimento", indexes = {
...
}, check = @CheckConstraint(name = "ck_registro_atendimento_campos_textuais", constraint = "char_length(trim(queixa_principal)) > 0 and char_length(trim(anamnese)) > 0 and char_length(trim(conduta)) > 0"))
@NoArgsConstructor
