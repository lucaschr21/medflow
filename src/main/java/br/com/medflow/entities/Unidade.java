...
}, uniqueConstraints = @UniqueConstraint(name = "uk_unidade_organizacao_nome", columnNames = { "organizacao_id",
        "nome" }), check = @CheckConstraint(name = "ck_unidade_campos_textuais", constraint = "char_length(trim(nome)) > 0 and char_length(trim(telefone)) > 0"))
@NoArgsConstructor
