...
public class Organizacao extends BaseEntity {
  ...
  public void definirLogotipoImagem(byte[] logotipoImagem) {
    this.logotipoImagem =
        logotipoImagem == null ? null : Arrays.copyOf(logotipoImagem, logotipoImagem.length);
  }

  public byte[] getLogotipoImagem() {
    return logotipoImagem == null ? null : Arrays.copyOf(logotipoImagem, logotipoImagem.length);
  }
