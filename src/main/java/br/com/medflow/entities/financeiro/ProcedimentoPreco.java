...
public class ProcedimentoPreco extends BaseEntity {
    ...
    @DecimalMin(value = "0.00", inclusive = true, message = "Valor da seguradora não pode ser negativo")
    ...
    public void definirCodigoProcedimento(String codigoProcedimento) {
        this.codigoProcedimento = Objects.requireNonNull(codigoProcedimento, "Código do procedimento é obrigatório");
    }
